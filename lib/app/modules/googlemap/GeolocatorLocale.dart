...
class GeolocatorLocale extends StatefulWidget {
  @override
  _GeolocatorLocaleState createState() => _GeolocatorLocaleState();
}

class _GeolocatorLocaleState extends State<GeolocatorLocale> {
