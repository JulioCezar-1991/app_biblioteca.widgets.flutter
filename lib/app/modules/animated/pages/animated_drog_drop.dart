...
class DragAndDropAppExample extends StatefulWidget {
  @override
  DragAndDropAppExampleState createState() => DragAndDropAppExampleState();
}

class DragAndDropAppExampleState extends State<DragAndDropAppExample> {
  int position = 1;
      ...
      body: Column(
        children: <Widget>[
          ...
          Expanded(
            child: Row(
              children: <Widget>[
                Expanded(child: DragTargetExample()),
                Expanded(child: DragTargetExample()),
                Expanded(child: DragTargetExample()),
                Expanded(child: DragTargetExample()),
              ],
...
class DragTargetExampleState extends State<DragTargetExample> {
  ...
  Widget build(BuildContext context) {
    return DragTarget<Color>(
      ...
      builder:
          (BuildContext context, List<Color> data, List<dynamic> rejectedData) {
        return Container(
          height: 100.0,
...
class Dot extends StatefulWidget {
  const Dot({Key key, this.color, this.size, this.child, this.tappable = false})
      : super(key: key);
...
class ExampleDragSource extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (heavy) size *= kHeavyMultiplier;
