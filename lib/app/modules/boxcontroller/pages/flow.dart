...
class FlowExample extends StatefulWidget {
  @override
  FlowExampleState createState() {
    return FlowExampleState();
  }
}

class FlowExampleState extends State<FlowExample>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(
        child: Flow(
          delegate: ExampleFlowDelegate(opacity: 0.8, startOffset: start),
          children: [
