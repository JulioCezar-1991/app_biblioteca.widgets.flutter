...
class NavigationStepper extends StatefulWidget {

  @override
  _NavigationStepperState createState() => _NavigationStepperState();
}

class _NavigationStepperState extends State<NavigationStepper> {
  int stepCounter = 0;
  List<Step> steps = [
    Step(
      title: Text("Step One"),
